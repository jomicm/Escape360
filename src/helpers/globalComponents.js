module.exports = (width, height) => {
  return {
    ...
    general: [
      ...
      { name: 'myAbstractArtFixedSurface', root:'AbstractArtFixed', props: {}, size: { width: 500, height: 600 }, angle: [0.95, 0.04, 0], radius: 5 },
      { name: 'myAbstractArtDynamicSurface', root:'AbstractArtDynamic', props: {}, size: { width: 850, height: 820 }, angle: [-.64, -0.01, 0], radius: 5 },
    ],
